...
final class OpenRouterGatewayServiceTests: CodexPanelTestCase {
    ...
    func testWebSocketBridgeProbeUnwrapsResponseCreateEnvelopeAndSynthesizesAssistantMetadata() async throws {
        ...
        XCTAssertEqual(assistant["id"] as? String, "msg_codexpanel_0")
    }
    ...
    private func makeOpenRouterProvider(selectedModelID: String) -> CodexPanelProvider {
