...
final class OpenAISessionAttributionServiceTests: CodexPanelTestCase {
    func testLoadAttributesSessionsUsingLatestPrecedingActivation() throws {
        ...
        let sessionStore = SessionLogStore(
            ...
            persistedCacheURL: home.appendingPathComponent(".codexpanel/test-attribution-cache.json")
        )
        let journalStore = SwitchJournalStore(
            fileURL: home.appendingPathComponent(".codexpanel/switch-journal.jsonl")
        )
