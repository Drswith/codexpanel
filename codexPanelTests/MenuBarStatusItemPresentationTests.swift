...
final class MenuBarStatusItemPresentationTests: XCTestCase {
    ...
    func testAggregateModeUsesAggregateRoutedAccountSummary() {
        ...
        let provider = CodexPanelProvider(id: "openai", kind: .openAIOAuth, label: "OpenAI")
    ...
    func testFallbackProviderLabelIsTrimmed() {
        let provider = CodexPanelProvider(id: "compatible", kind: .openAICompatible, label: "ProviderLong")
    ...
    func testStatusItemImageUsesTemplateRendering() {
        ...
        let image = presentation.makeTemplateImage(accessibilityDescription: "Codex Panel")
