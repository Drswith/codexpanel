        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack {
                Button("Open Browser", action: onOpenBrowser)
                    ...
                    .accessibilityIdentifier("codexpanel.oauth.open-browser")
                Button("Copy Link", action: onCopyLink)
                    .buttonStyle(.bordered)
                    .accessibilityLabel("Copy Login Link")
                    .accessibilityIdentifier("codexpanel.oauth.copy-link")
            }
            ...
            TextEditor(text: $callbackInput)
                ...
                .accessibilityIdentifier("codexpanel.oauth.callback-input")
            ...
            HStack {
                ...
                .accessibilityIdentifier("codexpanel.oauth.cancel")
                ...
                .accessibilityIdentifier("codexpanel.oauth.complete-login")
            }
        }
        .padding(16)
        .frame(width: 520)
