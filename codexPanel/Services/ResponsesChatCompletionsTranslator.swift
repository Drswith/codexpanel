...
enum ResponsesChatCompletionsTranslator {
    ...
    private static func messages(from body: [String: Any], quirks: CodexPanelChatQuirks) -> [[String: Any]] {
    ...
    private static func messageContent(_ content: Any?, quirks: CodexPanelChatQuirks) -> Any {
