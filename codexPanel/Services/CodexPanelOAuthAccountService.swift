...
struct CodexPanelOAuthAccountService {
    ...
    private func makeTokenAccount(from stored: CodexPanelProviderAccount, config: CodexPanelConfig) -> TokenAccount? {
    ...
    private func shouldSynchronize(config: CodexPanelConfig) -> Bool {
    ...
    private func persist(
        config: CodexPanelConfig,
        previousConfig: CodexPanelConfig,
        synchronizeCodex: Bool
    ) throws {
        let finalConfig: CodexPanelConfig
        if synchronizeCodex,
