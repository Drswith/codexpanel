...
final class LocalhostOAuthCallbackServer {
    ...
    private let queue = DispatchQueue(label: "com.codexpanel.oauth-callback-server")
    ...
    private static let successResponse = LocalhostOAuthCallbackServer.httpResponse(
        ...
        <head>
          ...
          <title>Codex Panel Login Received</title>
          <style>
            body {
              margin: 0;
              min-height: 100vh;
        ...
        <body>
          <div class="card">
            ...
            <p>Codex Panel captured the localhost callback. You can return to the app now.</p>
          </div>
        </body>
        </html>
        """
