...
enum CodexPaths {
    ...
    static var codexBarRoot: URL {
        self.realHome.appendingPathComponent(".codexpanel", isDirectory: true)
    }
    ...
    static var menuHostAppURL: URL { self.menuHostRootURL.appendingPathComponent("codexpanel.app", isDirectory: true) }
    ...
    static var recordsSnapshotCacheURL: URL { self.codexBarRoot.appendingPathComponent("records-snapshot-cache.json") }
    ...
    static var configBackupURL: URL { self.codexRoot.appendingPathComponent("config.toml.bak-codexpanel-last") }
    static var authBackupURL: URL { self.codexRoot.appendingPathComponent("auth.json.bak-codexpanel-last") }
