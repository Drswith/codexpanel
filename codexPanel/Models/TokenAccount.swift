...
extension TokenAccount {
    ...
    nonisolated func planQuotaMultiplier(
        using quotaSortSettings: CodexPanelOpenAISettings.QuotaSortSettings
    ) -> Double {
    ...
    nonisolated var planQuotaMultiplier: Double {
        self.planQuotaMultiplier(using: CodexPanelOpenAISettings.QuotaSortSettings())
    }
    ...
    nonisolated var weightedPrimaryRemainingPercent: Double {
        self.weightedPrimaryRemainingPercent(using: CodexPanelOpenAISettings.QuotaSortSettings())
    }
    ...
    nonisolated var weightedSecondaryRemainingPercent: Double {
        self.weightedSecondaryRemainingPercent(using: CodexPanelOpenAISettings.QuotaSortSettings())
    }
    ...
    nonisolated func compactUsageSummary(mode: CodexPanelUsageDisplayMode) -> String? {
    ...
    nonisolated func compactPrimaryUsageSummary(mode: CodexPanelUsageDisplayMode) -> String? {
