...
enum MenuBarStatusItemIdentity {
    ...
    static let accessibilityLabel = "codexpanel"
    static let accessibilityIdentifier = "codexpanel.status-item"
    static let statusItemAutosaveName: NSStatusItem.AutosaveName = "com.codexpanel.menu-bar-status-item"
