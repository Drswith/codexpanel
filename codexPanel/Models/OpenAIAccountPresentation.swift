...
struct OpenAIAccountRowState: Equatable {
    ...
    let accountUsageMode: CodexPanelOpenAIAccountUsageMode
    ...
    func showsManualActivationAction(
        defaultBehavior: CodexPanelOpenAIManualActivationBehavior?
    ) -> Bool {
        _ = defaultBehavior
...
enum OpenAIAccountPresentation {
    ...
    static func aggregateSummaryTitle(
        ...
        usageDisplayMode: CodexPanelUsageDisplayMode
    ) -> String {
